        ...
        private void botFatherLink_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            try
            {
                if (Processes.OpenLink("https://t.me/botfather") == false)
                    Processes.Open("https://t.me/botfather");
            }
            catch
            {
            ...
            try
            {
                TomlTable toml = new TomlTable
                {
                    ...
                    ["ui"] =
                    {
                        ...
                        ["use_window_mini_mode"] = false,
                        ["menu_color"] = "default",
                        ["use_window_transparency"] = false,
                        ["use_window_animation"] = true,
                    }
                };
                using (StreamWriter writer = File.CreateText($@"{Application.StartupPath}\data\settings\main.toml"))
                {
                    toml.WriteTo(writer);
                    writer.Flush();
                }
