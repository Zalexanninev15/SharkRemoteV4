...
namespace Shark_Remote.Helpers.imgBB
{
    public class Uploader
    {
        ...
        public async Task<Response> UploadImageFileAsync(string filename,
            string? name = null)
        {
        ...
        public async Task<bool> DeleteAsync(string deleteUrl) => throw new NotImplementedException();
    }
}